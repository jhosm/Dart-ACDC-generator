...
API for testing file upload type mapping (multipart vs non-multipart contexts)

## Overview

This API client was generated by the [Dart-ACDC OpenAPI Generator](https://github.com/jhosm/Dart-ACDC-generator) for File Upload Test API.

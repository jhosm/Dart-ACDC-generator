# acdc-features Specification

## Purpose
Integration of the four Dart-ACDC library pillars (Authentication, Caching, Debugging, Client) into the generated API client, providing production-ready configuration and documentation out of the box.
## Requirements
...
- **AND** disk cache size SHALL be 50 MB

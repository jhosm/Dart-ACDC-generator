...
> **Latest Architecture**: For detailed architectural decisions including naming conventions (`*RemoteDataSource`), the abstract interface + implementation pattern, and configuration classes, see [ADR-001: Generated Code Architecture](./adr-001-generated-code-architecture.md).

# Dart-ACDC-FAST Generator - Project Vision
...
Current workflow:
```
OpenAPI Spec → Generate Client → Manual Integration with Dart-ACDC → Production App
                                  ↑
...
Ideal workflow:
```
OpenAPI Spec → Generate ACDC-Integrated Client → Production App
                ↑
...
java -jar openapi-generator-cli.jar meta \
  -o out/generators/dart-acdc-fast \
  -n dart-acdc-fast \
  -p com.acdc.codegen
```
...
1. ✅ **Dart-ACDC integration out of the box**
2. ✅ **Production-ready code** (not just scaffolding)
3. ✅ **Type-safe error handling**
4. ✅ **Authentication built-in**
5. ✅ **Offline support and caching**
6. ✅ **Proper Dart/Flutter conventions**
7. ✅ **Comprehensive documentation**

### Generated Code Example

```dart
// Generated by dart-acdc-fast generator
...
├── analysis_options.mustache       # Linting configuration
├── gitignore.mustache             # Git ignore file
└── libraries/
    ├── json_serializable/          # JSON serializable templates
    │   ├── model.mustache
    │   └── serializers.mustache
    └── freezed/                    # Freezed templates (optional)
        └── model.mustache
```
...
5. **Test with Petstore**
   ```bash
   ./bin/generate-samples.sh ./bin/configs/dart-acdc-fast-petstore.yaml
   cd samples/client/petstore/dart-acdc-fast
   dart analyze
   dart test
   ```
...
The **Dart-ACDC-FAST Generator** bridges the gap between OpenAPI specification and production-ready Flutter apps by combining:
